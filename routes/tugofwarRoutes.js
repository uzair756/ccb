...
router.post('/startmatchtugofwar', authenticateJWT, async (req, res) => {
...
router.post('/stopmatchtugofwar', authenticateJWT, async (req, res) => {
    const { matchId } = req.body;
...
router.post('/updateGoaltugofwar', authenticateJWT, async (req, res) => {
    try {
...
router.post('/updateHalftugofwar', authenticateJWT, async (req, res) => {
...
router.post('/updateHalf3rdtugofwar', authenticateJWT, async (req, res) => {
    const { matchId, quarter } = req.body;
    const sportCategory = req.user.sportscategory;
  ...
  router.post('/swapPlayerstugofwar', authenticateJWT, async (req, res) => {
    try {
